...
const tags_block = document.getElementsByClassName("tags-block")[0];
const tags_icon = document.getElementsByClassName("tags-icon")[0];
...
tags_icon.addEventListener("click", function () {
    tags_block.classList.toggle('hidden');
});
