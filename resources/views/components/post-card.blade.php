<div class="post min-[1px]:text-xs max-[450px]:text-xs md:text-base flex bg-post mb-6 flex-col rounded-md border border-pink-800">
    <div class="flex justify-between items-center border-b border-pink-800 p-1">
        <div class="flex items-center">
            <i class="fa-solid text-slate-300 w-[14px] h-[16px] fa-unlock mr-1"></i>
            <p class="text-slate-300">Available for everyone</p>
        </div>
        <time datetime="2023.02.18" class="text-slate-300">1 January 23:11</time>
    </div>
    <h2 class="px-1 font-semibold text-lg py-2 text-center">Anime AMW</h2>
    <div class="video-block mx-1 my-1 rounded-md">
        <video controls autoplay muted>
            <source src="{{ asset('videos/Teeth.mp4') }}">
        </video>
        {{-- <iframe width="100%" class="2xl:h-[504px] xl:h-[420px] lg:h-[330px] md:h-[275px] sm:h-[230px]" src="https://www.youtube.com/embed/M-1FA3FiL9s" title="Teeth - AMV - 「 Anime MV」 - AnimeMix" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> --}}
    </div>
    <div class="flex flex-col my-1 px-1">
        <div class="">
            <img class="post-image w-max h-max float-left mr-3 mt-2" src="{{ asset('images/chainsawman_bg.jpeg') }}" alt="">
    ...
    <div class="flex justify-between items-center border-t border-pink-800 p-1 px-2">
        <div class="flex items-center">
            <a class="flex items-center mr-2" href="#">
                ...
                <p class="pr-1 text-pink-800">10</p>
            </a>
            <a class="flex items-center mr-2" href="#">
                <i class="fa-solid text-pink-800 fa-eye mr-1"></i>
                <p class="pr-1 text-pink-800">253</p>
            </a>
        </div>
        <a href="#">
            <i class="fa-solid text-pink-800 fa-share-nodes fa-lg"></i>
        </a>
    </div>
</div>